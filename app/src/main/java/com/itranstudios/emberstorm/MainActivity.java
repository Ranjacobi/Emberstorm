...
public class MainActivity extends Activity implements BillingManager.Callback {
    ...
    /** Exposed to the game JS as window.Android */
    class JsBridge {
        @JavascriptInterface
    ...
    // ---- BillingManager.Callback: push results back into the web layer ----
    ...
    @Override public void onPrices(String json){ evalJs("window.setPrices && window.setPrices(" + json + ")"); }
