...
public class MainActivity extends Activity implements BillingManager.Callback {
    ...
    // Google TV remote D-pad → inject JS keyboard events
    @Override public boolean onKeyDown(int keyCode, android.view.KeyEvent event) {
        ...
        switch (keyCode) {
            ...
            case android.view.KeyEvent.KEYCODE_BUTTON_A:
                key = " "; break;
            case android.view.KeyEvent.KEYCODE_DPAD_UP:    key = "ArrowUp"; break;
            case android.view.KeyEvent.KEYCODE_DPAD_DOWN:  key = "ArrowDown"; break;
            case android.view.KeyEvent.KEYCODE_DPAD_LEFT:  key = "ArrowLeft"; break;
            case android.view.KeyEvent.KEYCODE_DPAD_RIGHT: key = "ArrowRight"; break;
            case android.view.KeyEvent.KEYCODE_BACK:
            case android.view.KeyEvent.KEYCODE_ESCAPE:     key = "Escape"; break;
        }
        if (key != null && web != null) {
            evalJs("window.dispatchEvent(new KeyboardEvent('keydown',{key:'" + key + "',bubbles:true}))");
            return true;
        }
